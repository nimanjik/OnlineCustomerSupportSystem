...
function passValue(value) {
  localStorage.packagePrice = value; //localStorage object store key-value
}

window.addEventListener('DOMContentLoaded', function() { //This event is fired when the HTML document has finished loading 
